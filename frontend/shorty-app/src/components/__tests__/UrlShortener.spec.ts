...
const defaultExpectedHtml = `<div data-v-8174189b="" class="center-screen">
  <div data-v-f3006f2f="" data-v-8174189b="" class="url-input"><input data-v-f3006f2f="" type="text" placeholder="https://www.very-long-url.com" value=""><button data-v-6c14b1e7="" data-v-f3006f2f="" class="generate-btn">
      <!--v-if--><img data-v-6c14b1e7="" alt="generate-img" src="/src/components/icons/generate-dark.svg" width="38" height="38">
    </button></div>
  <!--v-if-->
  <!--v-if-->
